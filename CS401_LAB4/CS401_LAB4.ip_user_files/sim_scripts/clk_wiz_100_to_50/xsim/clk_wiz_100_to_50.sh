...
#
# Script generated by Vivado on Sat Nov 22 18:23:50 +0300 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : clk_wiz_100_to_50.sh
...
#
# Usage        : clk_wiz_100_to_50.sh
#                clk_wiz_100_to_50.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_wiz_100_to_50.sh [-reset_run]
#                clk_wiz_100_to_50.sh [-reset_log]
#                clk_wiz_100_to_50.sh [-help]
#
...
# script info
echo -e "clk_wiz_100_to_50.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_wiz_100_to_50.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz_100_to_50 xil_defaultlib.clk_wiz_100_to_50 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clk_wiz_100_to_50 -key {Behavioral:sim_1:Functional:clk_wiz_100_to_50} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Kod/Vivado/2023.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clk_wiz_100_to_50.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clk_wiz_100_to_50.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clk_wiz_100_to_50.sh [-help]\n\
Usage: clk_wiz_100_to_50.sh [-step]\n\
Usage: clk_wiz_100_to_50.sh [-lib_map_path]\n\
Usage: clk_wiz_100_to_50.sh [-reset_run]\n\
Usage: clk_wiz_100_to_50.sh [-reset_log]\n\
Usage: clk_wiz_100_to_50.sh [-keep_index]\n\
Usage: clk_wiz_100_to_50.sh [-noclean_files]\n\n\
